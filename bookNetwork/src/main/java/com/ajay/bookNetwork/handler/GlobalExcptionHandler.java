...
import static com.ajay.bookNetwork.handler.BusinessErrorCodes.ACCOUNT_DISABLED;
import static com.ajay.bookNetwork.handler.BusinessErrorCodes.ACCOUNT_LOCKED;
import static com.ajay.bookNetwork.handler.BusinessErrorCodes.BAD_CREDENTIALS;
        ...
        return ResponseEntity
                ...
                .body(
                        ExceptionResponse.builder()
                                ...
                                .errorCode("Login and / or Password is incorrect")
                                .build()
                );
    }
